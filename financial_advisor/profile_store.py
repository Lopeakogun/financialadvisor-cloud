...
PROFILE_SCHEMA = {
    ...
    "income": {"label": "Monthly or yearly income and how stable it is", "required": True},
    "expenses": {"label": "Typical monthly expenses", "required": True},
    "leftover": {"label": "Roughly how much is left over each month after expenses", "required": True},
